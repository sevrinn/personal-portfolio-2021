 ...
 * );
 */
$config['recipients'] = 'contact@christinas-aesthetics.com';
 ...
 */
$config['subject'] = 'Message from %first_name% %last_name%';
 ...
 * Validators: Required
 */
$first_name = new Quform_Element('first_name', 'First Name');
 ...
 * Validators: Required
 */
$last_name = new Quform_Element('last_name', 'Last Name');
$last_name->addFilter('trim');
$last_name->addValidator('required');
